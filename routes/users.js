    ...
    async(req, res) => {
      ...
      try {
        ...
        if (result) {
          ...
          // Add student details in the DB
          await promisePool.query(
              `INSERT INTO visitor (visitor_id, visitor_name, visitor_gender, visitor_phone, visitor_status) VALUES (${user_id},"${visitor_name}", "${visitor_gender}", "${visitor_phone}", "offline")`
          );
